package com.tech.gigabyte.circularreveal;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Getting Toolbar --> Toolbar to set as the Activity's action bar
    ...
    private void viewMenu() {
        ...
        if (!isOpen) {
            ...
            //Animator is superclass for classes which provide basic support for animations which can be started, ended,
            Animator anim = ViewAnimationUtils.createCircularReveal(layoutButtons, x, y, startRadius, endRadius);
            anim.addListener(new Animator.AnimatorListener() {
                ...
                //Setting Visibility When Animation Ended
                @Override
